                ...
                <div className="text-center">
                    ...
                    <div className="mx-auto max-w-md rounded-3xl border border-white/10 bg-black/60 p-8 shadow-2xl backdrop-blur-xl md:p-12">
                        ...
                        <button
                            ...
                            className="mx-auto flex items-center justify-center gap-3 rounded-full bg-green-500 px-8 py-4 text-lg font-bold text-white shadow-lg transition-all transform hover:scale-105 hover:bg-green-600 active:scale-95 cursor-pointer"
                        >
